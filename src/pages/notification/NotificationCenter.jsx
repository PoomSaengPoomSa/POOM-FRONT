    ...
    <div className="notif-container">
      ...
      <div className="notif-main">
        <div className="notif-content-card">
          <div className="notif-page-title" style={{ display: 'flex', justifyContent: 'space-between', width: '100%', marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              알림 센터 <span className="notif-page-subtitle">실시간 고객 상담 브리핑 및 주요 알림 내역</span>
            </div>
          </div>

          {/* Tab Selection Row */}
          <div className="notif-alert-tabs-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div className="notif-alert-tabs">
              <button 
                className={`notif-alert-tab ${activeTab === 'today' ? 'active' : ''}`}
                onClick={() => { setActiveTab('today'); setActiveDetailId(null); setShowOlder(false); }}
              >
                오늘
              </button>
              <button 
                className={`notif-alert-tab ${activeTab === 'all' ? 'active' : ''}`}
          ...
          <div className="notif-alert-list">
            {(() => {
              ...
              return filteredNotifications.map((notif) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="notif-alert-right">
                      <div className="notif-alert-date-wrap">
                        <CalendarIcon size={16} color="#3b82f6" />
                        <span className="notif-alert-date">{notif.date}</span>
                      </div>
                      <button className="notif-alert-more-btn" onClick={(e) => e.stopPropagation()}>
                  ...
                  {isExpanded && notif.expandedContent && (
                    <div className="notif-alert-expanded-content">
                      {notif.expandedContent.map((line, idx) => (
                        <div key={idx} className="notif-alert-expanded-line">
                          {line}
                        </div>
                      ))}
                      {notif.c_id && (
                        <div style={{ marginTop: '12px', display: 'flex', justifyContent: 'flex-end' }}>
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              navigate(`/customer-info?c_id=${notif.c_id}`);
                            }}
                            style={{
                              padding: '6px 12px',
                              fontSize: '12px',
          ...
          >
            ...
            <div className="briefing-modal-header">
              <div className="briefing-modal-header-left" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span className="notif-alert-badge badge-green">방문 예정 브리핑</span>
